...
with st.expander(("How Machine Learning Works")):
    st.markdown((
        """

    - First, the model is trained using a large set of health records collected previously. Each record has details about a person’s health and a label indicating whether they have diabetes (1) or not (0). 
...
- 👈 use the menu on the left to fill in the data
- 👇 find out your result 
"""

st.sidebar.markdown("## Please fill in your data")
...
BMI = st.sidebar.slider('What is your Body Mass Index?')  # 👈 this is a widget
...
After you click the "Explanations" button, you will see them in the form of graphs.

Please share your thoughts on the format of the explanations. Your feedback is very valuable and I encourage you to say whatever you think. 

That way we can determine the shortcomings and strengths of the method and find potential areas for improvement. 

Thanks for agreeing to participate in this study! ❤️
...
if st.button('Explanations'):
    ...
    class_index = 1
    data_index = 0
    st_shap(shap.plots.waterfall(shap_values[data_index,:,class_index]), height=300, width=900)
    ...
    class_index=1
    st_shap(shap.plots.bar(shap_values[data_index,:,class_index]), height=300, width=900)

    shap.initjs()
    st_shap(shap.plots.force(shap_values[data_index,:,class_index]), width=900)
